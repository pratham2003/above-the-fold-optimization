						...
						<fieldset class="limited" style="display:none;" id="limitedoffer">
							...
							<div class="c">
								...
								<ul>
									...
									<li>Professional HTML optimization. Most (premium) plugins simply compress HTML using regular expressions, the new plugin will provide professional quality HTML optimization using professional software to deliver the best (and reliable) result possible.</li>
