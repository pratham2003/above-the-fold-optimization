					...
					<div class="inside testcontent">
						...
						<fieldset class="limited" style="display:none;" id="limitedoffer">
							...
							<div class="c">
								...
								<p>To apply for the offer please send 100 USD to PayPal <a href="https://www.paypal.me/pagespeed/100usd" target="_blank">info@pagespeed.pro</a> (verified business account, 15 years old). We will provide you with life time access to the plugin and Optimization API and provide premium installation for 1 website as soon as the new optimization plugin is ready.</p>
