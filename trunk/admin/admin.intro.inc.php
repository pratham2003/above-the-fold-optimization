				...
				<div class="postbox">
					...
					<div class="inside testcontent">
						...
						<div style="text-align:center;">
							<h1>Limited Time Offer: Life Time Access To <strong>New Optimization Plugin</strong></h1>
						...
						<fieldset class="limited" style="display:none;" id="limitedoffer">
							...
							<div class="c">
								...
								<ul>
									...
									<li>Professional CSS minification and optimization. Similar to Javascript optimization, the new plugin will offer advanced CSS optimization such as the removal of unused / dead CSS to achieve a smaller size and much better CSS performance.</li>
									<li>Professional HTML optimization. Most (premium) plugins simply compress HTML using regular expressions, the new plugin will provide professional quality HTML optimization using professional software to deliver the best (and a reliable) result.</li>
									<li>Professional image optimization. Most image optimization plugins depend on PHP based solutions, the new plugin will enable the use of the latest professional image optimization software including <a href="https://developers.google.com/speed/webp/?hl=<?php print $lgcode;?>" target="_blank">Google WebP image optimization</a> (a unique feature, beneficial for SEO).</li>
								...
								<p>The offer will <strong>save hundreds of dollars</strong> in subscription costs and premium installation support is provided for free (an additional saving of hundreds of dollars).</p>
